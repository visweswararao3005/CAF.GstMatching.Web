...
namespace CAF.GstMatching.Web.Controllers
{
    public class MainAdminController : Controller
    {
        ...
        public MainAdminController(ILogger<MainAdminController> logger,
        ...
        public async Task<IActionResult> MapGstin()
        {
            ...
            return View("~/Views/MainAdmin/MapGstin/MapGstin.cshtml");
        ...
        public async Task<IActionResult> AddClientsOrRemoveClients([FromBody] ClientActionPayload payload)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError(ex, "Error occurred while mapping client to MainAdmin for email: {Email}", email);
                return StatusCode(500, "An error occurred on the server.");
            }

            return RedirectToAction("MapGstin", "MainAdmin");
        }
        ...
        public async Task<IActionResult> ManageUserAccess()
        {
			...
			// Get the list of MainAdmin emails from configuration
			var MainAdminEmails = (await _userBusiness.GetMainAdminUsers())
	                                .Select(e => e.Email.ToLower())
	                                .ToArray();
			// Restrict access if user not in MainAdmin list
			if (!MainAdminEmails.Contains(userEmail, StringComparer.OrdinalIgnoreCase))
            {
            ...
            // Filter out users whose Email is in MainAdminEmails
            var filteredUsers = allUsers
                .Where(u => !MainAdminEmails.Contains(u.Email?.Trim().ToLower()))
                .ToList();
            ViewBag.allUsers = filteredUsers;

            return View("~/Views/MainAdmin/ManageUserAccess/ManageUserAccess.cshtml");
        }
        ...
        public async Task<IActionResult> EditUploadGST(string requestNo)
        {
            ...
            return View("~/Views/MainAdmin/PurchaseRegister/UploadGST.cshtml");
        }
        ...
        public async Task<IActionResult> UploadGST(IFormFile gstFile, string financialYear, string periodtype, string period, string requestNo)
        {
            ...
            return RedirectToAction("Upload", "MainAdmin", new { ticketId, Edit });
        }
        ...
        public IActionResult OpenRequestsCSV()
        {
            ...
            return RedirectToAction("OpenTaskCSV", "MainAdmin");
        }
        ...
        public async Task<IActionResult> OpenTaskCSV(DateTime? fromdate, DateTime? todate)
        {
            ...
            if (fromdate.HasValue && todate.HasValue && fromdate > todate)
            {
                ...
                return View("~/Views/MainAdmin/OpenTasks/OpenTaskCSV.cshtml");
            }
            ...
            return View("~/Views/MainAdmin/OpenTasks/OpenTaskCSV.cshtml"); // MainAdmin dashboard

            //based on his clients Gstin Fetch tickets and show in opentickets page
            //step -1
            // based on his id get the client gstin list from MainAdmin_client_link table
            //let say this MainAdmin with back@end.com mail id have 3 clients their gstin is {1,2,3} 
        ...
        public async Task<IActionResult> CompareGSTCSV(string ticketnumber, string ClientGSTIN, string fromDate, string toDate)
        {
            ...
            return View("~/Views/MainAdmin/CompareGstFiles/CompareGSTCSV.cshtml");
        }
        ...
        public async Task<IActionResult> CompareCSV(IFormFile Portal, string ticketnumber, string ClientGSTIN)
        {
            ...
            string MainAdminFileName = Path.GetFileName(Portal.FileName);
            //Console.WriteLine($"MainAdminFileName: {MainAdminFileName}"); // Log the file name for debugging
            ...
            await _purchaseTicketBusiness.UpdatePurchaseTicketAsync(ticketnumber, ClientGSTIN, MainAdminFileName);
            ...
            return View("/Views/MainAdmin/CompareGstFiles/Compare.cshtml");
        }
        ...
        public async Task<IActionResult> getUnMatchedData(string requestNo, string ClientGstin, string matchType)
        {
            ...
            return View("~/Views/MainAdmin/CompareGstFiles/ModifyData.cshtml", model);
        }
        ...
        public async Task<IActionResult> EditCompare(string RequestNo, string ClientGSTIN, string InvoiceTable, string PortalTable)
        {
            ...
            try
            {
                ...
                // Get ticket info
                var Ticket = await _purchaseTicketBusiness.GetUserDataBasedOnTicketAsync(RequestNo, ClientGSTIN);
                var MainAdminFileName = Ticket.AdminFileName;
                ...
                // Update ticket info
                await _purchaseTicketBusiness.UpdatePurchaseTicketAsync(RequestNo, ClientGSTIN, MainAdminFileName);
        ...
        public IActionResult OpenRequestsAPI_Master()
        {
            ViewBag.Messages = "MainAdmin";
            ViewData["ActiveAction"] = "act2"; // For active button styling
            return RedirectToAction("OpenTaskAPI_Master", "MainAdmin");
        }
        ...
        public async Task<IActionResult> OpenTaskAPI_Master(DateTime? fromdate, DateTime? todate)
        {
            ...
            {
                ViewBag.Error = "From Date cannot be greater than To Date.";
                return View("~/Views/MainAdmin/OpenTasks/OpenTaskAPI_Master.cshtml");
            }
            ...
            return View("~/Views/MainAdmin/OpenTasks/OpenTaskAPI_Master.cshtml"); // MainAdmin dashboard
        }
        ...
        public async Task<IActionResult> CompareGSTAPI_Master(string ticketnumber, string ClientGSTIN, string fromDate, string toDate)
        {
            ...
            ViewBag.fromDate = fromDate;
            ViewBag.toDate = toDate;
            return View("~/Views/MainAdmin/CompareGstFiles/CompareGSTAPI_Master.cshtml");
        }
        ...
        public IActionResult OpenRequestsAPI_Iris()
        {
            ViewBag.Messages = "MainAdmin";
            ViewData["ActiveAction"] = "act2"; // For active button styling
            return RedirectToAction("OpenTaskAPI_IRIS", "MainAdmin");
        }
        ...
        public async Task<IActionResult> OpenTaskAPI_IRIS(DateTime? fromdate, DateTime? todate)
        {
            ...
            {
                ViewBag.Error = "From Date cannot be greater than To Date.";
                return View("~/Views/MainAdmin/OpenTasks/OpenTaskAPI_IRIS.cshtml");
            }
            ...
            return View("~/Views/MainAdmin/OpenTasks/OpenTaskAPI_IRIS.cshtml"); // MainAdmin dashboard
        ...
        public async Task<IActionResult> CompareGSTAPI_IRIS(string ticketnumber, string ClientGSTIN, string fromDate, string toDate)
        {
            ...
            return View("~/Views/MainAdmin/CompareGstFiles/CompareGSTAPI_IRIS.cshtml");
        }
        ...
        public async Task<IActionResult> CompareDataTables(string ticketnumber, string clientGSTIN)
        {
            ...
            string MainAdminFileName = $"{ticketnumber}_API_IRIS.csv";
            await _purchaseTicketBusiness.UpdatePurchaseTicketAsync(ticketnumber, clientGSTIN, MainAdminFileName);
        ...
        public async Task<IActionResult> ClosedRequests(DateTime? fromdate, DateTime? todate)
        {
            ...
            {
                ViewBag.Error = "From Date cannot be greater than To Date.";
                return View("~/Views/MainAdmin/ClosedTasks/ClosedTask.cshtml");
            }
        ...
        public async Task<IActionResult> ExportReport(string requestNo, string fileName, string ClientGSTIN)
        {
            ...
            var MainAdminFileName = ticketDetails.AdminFileName;
            ...
            if (status == "Analysed")
            {
                ExportFileName = $"{fileName.Split('.')[0]}_VS_{MainAdminFileName.Split('.')[0]}_Report.xlsx";
            }
            ...
            // return View("~/Views/MainAdmin/CompareGstFiles/CompareGST.cshtml"); // Redirect to the same view if needed  
        }
        ...
        #region Function to redirect to Purchase Register CompareCSVResults for MainAdmin
        ...
        {
            ViewBag.Messages = "MainAdmin";
            return View("~/Views/MainAdmin/ChangePassword/ChangePassword.cshtml");
        }
        ...
        public async Task<IActionResult> SalesLedgerUploadFile(string requestNo)
        {
            ...
            ViewBag.FileName = ticketDetails.FileName;
            return View("~/Views/MainAdmin/SalesRegister/UploadSalesLedgerFile.cshtml");
        }
        ...
        public async Task<IActionResult> SalesLedgerUploadFile(string financialYear, string periodtype, string period, string requestNo, IFormFile gstFile)
        {
            ...
            return RedirectToAction("SalesLedgerUpload", "MainAdmin", new { ticketId, Edit });
            // return View("~/Views/MainAdmin/SalesRegister/UploadSalesLedgerFile.cshtml");
        }
        ...
        public async Task<IActionResult> SalesLedgerCurrentRequestsCSV(DateTime? fromdate, DateTime? todate)
        {
            ...
            {
                ViewBag.Error = "From Date cannot be greater than To Date.";
                return View("~/Views/MainAdmin/SalesLedgerCurrentRequests/SalesLedgerCurrentRequestsCSV.cshtml");
            }
        ...
        public async Task<IActionResult> CompareSalesLedgerGSTCSV(string ticketnumber, string ClientGSTIN, string fromDate, string toDate)
        {
            ...
            return View("~/Views/MainAdmin/CompareSalesLedgerGstFiles/CompareSalesLedgerGSTCSV.cshtml");
        }
        ...
        public async Task<IActionResult> CompareSalesLedgerCSV(IFormFile EInvoice, IFormFile EWayBill, string ticketnumber, string ClientGSTIN)
        {
            ...
            // Console.WriteLine($"EInvoice_MainAdminFileName = {Path.GetFileName(EInvoice.FileName)}");    
            ...
            string EInvoice_MainAdminFileName = Path.GetFileName(EInvoice.FileName);
            //Console.WriteLine($"MainAdminFileName: {MainAdminFileName}"); // Log the file name for debugging
            DataTable EWayBill_dataTable = null;
            string EWayBill_extension = Path.GetExtension(EWayBill.FileName);
            string EWayBill_MainAdminFileName = Path.GetFileName(EWayBill.FileName);
            ...
            await _sLComparedDataBusiness.CompareDataAsync(SLInvoice, SLWayBill, SLEInvoice);
            await _sLTicketsBusiness.UpdateSLTicketAsync(ticketnumber, ClientGSTIN, EInvoice_MainAdminFileName, EWayBill_MainAdminFileName);
            ...
            return View("~/Views/MainAdmin/CompareSalesLedgerGstFiles/CompareSalesLedger.cshtml");
        }
        ...
        public async Task<IActionResult> SalesLedgerCurrentRequestsAPI_Master(DateTime? fromdate, DateTime? todate)
        {
            ...
            {
                ViewBag.Error = "From Date cannot be greater than To Date.";
                return View("~/Views/MainAdmin/SalesLedgerCurrentRequests/SalesLedgerCurrentRequestsAPI_Master.cshtml");
            }
        ...
        public async Task<IActionResult> CompareSalesLedgerGSTAPI_Master(string ticketnumber, string ClientGSTIN, string fromDate, string toDate)
        {
            ...
            ViewBag.fromDate = fromDate;
            ViewBag.toDate = toDate;
            return View("~/Views/MainAdmin/CompareSalesLedgerGstFiles/CompareSalesLedgerGSTAPI_Master.cshtml");
        }
        ...
        public async Task<IActionResult> SalesLedgerCurrentRequestsAPI_Iris(DateTime? fromdate, DateTime? todate)
        {
            ...
            {
                ViewBag.Error = "From Date cannot be greater than To Date.";
                return View("~/Views/MainAdmin/SalesLedgerCurrentRequests/SalesLedgerCurrentRequestsAPI_Iris.cshtml");
            }
        ...
        public async Task<IActionResult> CompareSalesLedgerGSTAPI_IRIS(string ticketnumber, string ClientGSTIN, string fromDate, string toDate)
        {
            ...
            return View("~/Views/MainAdmin/CompareSalesLedgerGstFiles/CompareSalesLedgerGSTAPI_IRIS.cshtml");
        }
        ...
        public async Task<IActionResult> CompareSLDataTables(string ticketnumber, string ClientGSTIN)
        {
            ...
            string EInvoice_MainAdminFileName = $"{ticketnumber}_EInvoice_IRIS_API.csv";
            string EWayBill_MainAdminFileName = $"{ticketnumber}_EWayBill_IRIS_API.csv";
        ...
        public IActionResult UploadNotice(string req, string Edit)
        {
            ...
            ViewBag.Message = req;
            ViewBag.Edit = Edit;
            return View("~/Views/MainAdmin/NoticeTracker/UploadNotice.cshtml");
        }
        ...
        public async Task<IActionResult> UploadNoticeFile(string noticeTitle, string noticeDate, string priority, string description, IFormFile uploadedFile, string requestNo)
        {
            ...
            catch (Exception ex)
            {
                ...
                return View("~/Views/MainAdmin/NoticeTracker/UploadNotice.cshtml", data);
            }
            ...
            return RedirectToAction("UploadNotice", "MainAdmin", new { req, Edit });
            //return View("~/Views/MainAdmin/NoticeTracker/UploadNotice.cshtml");
        }
        ...
        public async Task<IActionResult> ActiveNotices(DateTime? fromdate, DateTime? todate, string status, string priority, string message)
        {
            ...
            if (fromdate.HasValue && todate.HasValue && fromdate > todate)
            {
                ...
                return View("~/Views/MainAdmin/NoticeTracker/ActiveNotices.cshtml");
            }
        ...
        public async Task<IActionResult> UnreadNotices(string[] gstins)
        {
            //Console.WriteLine("HI");
        ...
        public async Task<IActionResult> ConversationChat(string requestNo, string ClientGSTIN, string fromDate, string toDate, string priority, string status)
        {
            ...
            return View("~/Views/MainAdmin/NoticeTracker/ConversationChat.cshtml");
        }
        ...
        public async Task<IActionResult> SaveChat(string message, string requestNumber, string ClientGstin)
        {
            ...
            var data = new NoticeChatModel
            {
                ...
                Source = "MainAdmin", // Set source as "MainAdmin"
            ...
            return RedirectToAction("ConversationChat", "MainAdmin"); // Redirect to ConversationChat after saving the chat message
        }
        ...
        public async Task<IActionResult> CloseNotice(string requestNo, string ClientGSTIN)
        {
            ...
            return RedirectToAction("ClosedNotices", "MainAdmin"); // Redirect to ActiveNotices after closing the notice
        }
        ...
        public async Task<IActionResult> ClosedNotices(DateTime? fromdate, DateTime? todate, string priority)
        {
            ...
            if (fromdate.HasValue && todate.HasValue && fromdate > todate)
            {
                ...
                return View("~/Views/MainAdmin/NoticeTracker/ClosedNotices.cshtml");
            }
        ...
        public async Task<IActionResult> PDF(string req, string gstin, string status, string priority, DateTime? fromDate, DateTime? toDate)
        {
            ...
            //         Console.WriteLine($"msg : {ViewBag.Message}");
            //return RedirectToAction("ActiveNotices", "MainAdmin", new { message = ViewBag.Message });
